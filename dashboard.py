...
with page1:
    ...
    hours = rental_bike_hour_df['hours'].to_numpy()
    count = rental_bike_hour_df['count'].to_numpy()
    day_mapped = rental_bike_hour_df['day_mapped'].to_numpy()
    
    fig1, ax1 = plt.subplots(figsize = (20,5))
    sns.pointplot(x=hours, y=count, hue=day_mapped, ax=ax1)
    ...
    registered = rental_bike_hour_df['registered'].to_numpy()
    fig2 , ax2 = plt.subplots(figsize = (20,5))
    sns.pointplot(x = hours, y = registered, hue = day_mapped, ax=ax2)
    ...
    casual = rental_bike_hour_df['casual'].to_numpy()
    fig3 , ax3 = plt.subplots(figsize = (20,5))
    sns.pointplot(x = hours, y = casual, hue = day_mapped, ax=ax3)
